...
import com.cch.cz.base.exception.CZException;
...
public class ClassUtil {
     ...
     */
    public static List<Class> scanPackage(boolean isChild, String... scanpackage) throws CZException {
        List<Class> classes = new ArrayList<Class>();
        // 获取包的名字 并进行替换
        for (String packags : scanpackage) {
            if (!UtilFun.isEmptyString(packags)) throw new CZException("package name is not null");
    ...
    private static void FindbyFile(String packageName, String url, boolean isChile, List<Class> classes) throws UnsupportedEncodingException {
        ...
        if (!dir.exists() || !dir.isDirectory()) {
            throw new CZException("用户定义包名 " + url + " 下没有任何文件");
        }
