    ...
    public String manager(Map<String, Object> para){
        String sql=new SQL(){{
            SELECT(" u.result,u.rmarks,u.status,u.target,u.create_date as createDate, s.name as sname,c.name as cname,c.contract_num as contractNum ,c.sex,c.id_card as idCard,c.sum_arrears as sumArrears\n" +
                    "  ,c.customer_phone_number as customerPhoneNumber ,c.customer_office_phone as customerOfficePhone ,c.customer_spouse as customerSpouse  ,c.customer_relative_name as customerRelativeName\n" +
                    ...
                    "  ,c.customer_relative_phone as customerOtherPhone ");
